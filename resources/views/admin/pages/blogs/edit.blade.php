...
<div class="row mt-3 p-3" >
    <div class="col-lg-12">
        <form @submit="updateBlog($event)" id="my-form">
            <div class="row">
                <div class="col-lg-8 background-primary p-3 mb-2" style="border-radius: 8px;">
                    <div class="mb-3 mt-3">
                        <label for="name" class="form-label">Blog Title:</label>
                        <input type="text" class="form-control input-primary" id="name" placeholder="Enter Blog Title" name="title" value="{{ $blogTarget->title }}">
                    </div>
                    {{--<div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control input-primary" id="contenttt" name="content">{!! $blogTarget->content !!}</textarea>
                    </div>
                </div>
                <div class="col-lg-3 p-3 background-primary mx-auto" style="border-radius: 8px;">
                    <div class="mb-3 p-3">
                        ...
                        <img src="{{ asset('assets/images/blogs/' . $blogTarget->image ) }}" alt="" class="w-100" id="productImagePrimary" style="border-radius: 4px;">
                        <input type="file" class="btn btn-primary w-100 mt-2" name="image" onchange="readURL(this,'productImagePrimary')"></input>
                    </div>
                    <button type="submit" class="btn btn-success w-100 p-3">UPDATE BLOG</button>
                </div>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios({
                            ...
                            method: 'post',
                            url: "{{ url(''). '/admin/blogs/'. $blogTarget->slug .'/edit' }}",
                            data: data
                        })
                        .then(res => {
