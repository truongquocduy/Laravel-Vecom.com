        ...
        <div class="row">
            <nav class="navbar navbar-expand-sm fixed-top navbar-light" style="height: 120px;background-color: white;">
                ...
                <div class="collapse navbar-collapse bg-light" id="collapsibleNavbar">
                    ...
                    <a class="navbar-brand mx-auto d-block" href="{{ route('front.homepage') }}"><img class="mx-auto d-block" src="{{ asset('assets/images/logo/logo.png') }}" width="100px" alt=""></a>
                    <ul class="navbar-nav">
                        @if(!Auth::check())
                            ...
                            <div class="col-md-3 col-lg-2 col-xl-2 col-6 mx-auto mb-4">
                                ...
                                <p>
                                    <a href="https://tinnhiemmang.vn/" class="text-reset" target="_blank">
                                        <img src="{{ asset('assets/images/banners/tinnhiemmang.png') }}" width="150px" alt="">
                                    </a>
                                </p>
                                <p>
                                    <a href="https://moit.gov.vn/" class="text-reset" target="_blank">
                                        <img src="{{ asset('assets/images/banners/bocongthuong.webp') }}" width="150px" alt="">
                                    </a>
                                </p>
                            </div>
                            <!-- Grid column -->
