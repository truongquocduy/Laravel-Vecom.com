...
<div class="container-fluid" style="margin-top:120px;" id="app">
    <div class="row">
        <div class="col-lg-8 mx-auto mt-4">
            <div class="row">
                <div class="col-lg-7">
                    <img src="{{ asset('assets/images/banners/login.webp') }}" class="w-100" alt="">
                </div>
                <div class="col-lg-5" v-if="isShowLogin">
                    ...
                    <form @submit="login($event)">
                        <div class="form-group">
                            <input type="email" class="form-control p-4" v-model="Lemail" placeholder="Email">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control p-4" v-model="Lpassword" placeholder="Mật khẩu">
                        </div>
                        ...
                        <button type="submit" class="btn btn-success p-3 w-100">Đăng nhập</button>
                    </form>
                    <hr>
                ...
                <div class="col-lg-5 pr-5" v-if="!isShowLogin">
                    <span v-if="resultRegister" class="bg-primary p-2 text-light pl-5 pr-5">Tạo tài khoản thành công</span>
                    <h3 class="mt-4"><strong>ĐĂNG KÝ THÀNH VIÊN</strong></h3>
                    <form>
                        <div class="form-group" style="display:flex;">
                            <input type="text" class="form-control p-4" placeholder="Họ Tên" v-model="Rname">
                        ...
                        <div class="form-group" style="display:flex;">
                            <input type="email" class="form-control p-4" placeholder="Email" v-model="Remail" @change="checkEmail()">
                        ...
                        <div class="form-group" style="display:flex;">
                            <input type="password" class="form-control p-4" placeholder="Mật khẩu" v-model="Rpassword">
                        ...
                        <div class="form-group" style="display:flex;">
                            <input type="password" class="form-control p-4" placeholder="Nhập lại mật khẩu" v-model="RpasswordCheck" @change="RpasswordcheckMethod()">
                        ...
                        <button type="button" class="btn btn-success p-3 w-100" @click="register()">Đăng nhập</button>
                    </form>
                    <hr>
